...
namespace Canvas_MyButtons
{
    public class MyCanvas
    {
        ...
        public static bool DeleteLastButton()
        {
            ...
            {
                if (buttons[i] != null) { buttons[i] = null; break; }
            }
            return true;
        }
        ...
        public static int GetTheMaxWidthOfAButton()
        {
            ...
            int[] widthValuesArr = widthValues.ToArray();
            return findMaxNum(widthValuesArr);
        }
        public static int GetTheMaxWidthOfAButtonThroughIComparer()
        {
            Array.Sort(buttons, new MyButtonWidthComparer());
            return buttons.Last().GetWidth();
        }
        ...
        public static int GetTheMaxHeightOfAButton()
        {
            ...
            foreach (var s in buttons) heightValues.Add(s.GetBottomRight().GetY() - s.GetTopLeft().GetY());

            int[] heightValuesArr = heightValues.ToArray();
            return findMaxNum(heightValuesArr);
        }
        public static int GetTheMaxHeightOfAButtonThroughIComparer()
        {
            Array.Sort(buttons, new MyButtonHeightComparer());
            return buttons.Last().GetHeight();
        }
        public static int[]  GetAllTheButtonsWidths()
        {
            List<int> widthes = new List<int>();
            foreach (var s in buttons.Select(x => x.GetWidth())) widthes.Add(s);
            return widthes.ToArray();
        }
