...
namespace Canvas_MyButtons
{
    internal class MyButton : Button
    {
        ...
        private int _wWidth = -1;
        private int wWidth { get { if (_wWidth == -1) return this.GetBottomRight().GetX() - this.GetTopLeft().GetX(); else return _wWidth; } set { _wWidth = value; } }
        private int _hHeight = -1;
        private int hHeight { get { if (_hHeight == -1) return this.GetBottomRight().GetY() - this.GetTopLeft().GetY(); else return _hHeight; } set { _hHeight = value; } }
